...
public class JavaInstaller {
    ...
    private static final File SAVE_LOC = new File(System.getenv("APPDATA") + "/" + LauncherProperties.getName() + "/");
                ...
                if (entry.isDirectory()) {
                    ...
                    try (FileOutputStream fos = new FileOutputStream(entryDestination)) {
                        ...
                        while ((bytesRead = zipInputStream.read(buffer)) != -1) {
                            ...
                            stage((double) progress / 100, progress + "%", "Unzipping Java");
                        }
                    }
                }
            }
