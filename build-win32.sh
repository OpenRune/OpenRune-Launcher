...
cp native/build-x86/src/Release/OpenRune.exe build/win-x86/
cp target/OpenRune.jar build/win-x86/
...
echo OpenRune.exe 32bit sha256sum
sha256sum build/win-x86/OpenRune.exe

dumpbin //HEADERS build/win-x86/OpenRune.exe
