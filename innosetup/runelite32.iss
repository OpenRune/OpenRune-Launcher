...
OutputBaseFilename=${project.finalName}Setup32

[Tasks]
Name: DesktopIcon; Description: "Create a &desktop icon";

[Files]
Source: "${project.projectDir}\build\win-x86\${project.finalName}.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "${project.projectDir}\build\win-x86\${project.finalName}.jar"; DestDir: "{app}"
