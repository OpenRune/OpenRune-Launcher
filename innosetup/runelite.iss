...
OutputBaseFilename=${project.finalName}Setup

[Tasks]
Name: DesktopIcon; Description: "Create a &desktop icon";

[Files]
Source: "${project.projectDir}\build\win-x64\${project.finalName}.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "${project.projectDir}\build\win-x64\${project.finalName}.jar"; DestDir: "{app}"
