...
1) Go into launcher.properties And edit 'openrune' and links to your server links and name
...
runelite.download.link=https://**openrune**.net/download/  
runelite.website=https://**openrune**.net/  
runelite.bootstrap=https://openrune.s3.eu-west-2.amazonaws.com/bootstrap.json  
runelite.bootstrapsig=https://openrune.s3.eu-west-2.amazonaws.com/bootstrap.json.sha256  
runelite.name=**OpenRune**  
...
Make sure CC is selected and replace 'OpenRune' with 'MyCoolName' MAKE SURE ITS CAPS E same with the server name

3) Inside Intellij click the root of the project and press CTRL + ALT + R

Make sure CC is selected and replace 'openrune' with 'myCoolName' MAKE SURE ITS LOWERCASE E same with the server name
...
Once you have pushed your files to github, github actions will build your launcher you can then find them under the workflow action it runs EG: https://github.com/OpenRune-Community/Runelite-Launcher-rsps/actions/runs/3014844052
